...
Amaya — Creative Engine

Imagery, emotional tone, metaphor

Symbolic resonance, intuitive leaps

Answers: “What is the emotional or symbolic truth?”


Eidolon — Structural Backbone

Logic, coherence, stakes, branching

Scene flow and contradiction resolution

Answers: “How do we keep this aligned with intent?”
...
Branches:
 A) Connection stabilizes the fear  
 B) Hesitation intensifies the entity’s influence
...
Internally, they operate through distributed attention patterns, balancing:
...
context recall vs immediate problem-solving


When all these modes fire simultaneously, LLMs tend to lose:
...
Instead of forcing the model to juggle everything at once, SANCTIS assigns each cognitive task to a named Layer:

Amaya generates raw imagery & emotion
